...
public class PlayerCombat : MonoBehaviour
{
    ...
    public void EquipWeapon(EquipmentItem item)
    {
        ...
        if (data is MeleeWeaponData meleeData)
        {
            ...
            attrs?.SetEquippedWeapon(meleeData.EquipmentID);
        ...
        else if (data is RangedWeaponData rangedData)
        {
            ...
            attrs?.SetEquippedWeapon(rangedData.EquipmentID);
        ...
        else if (data is ArmorData armorData)
        {
            ...
            if (attrs != null)
            {
                ...
                attrs?.SetEquippedArmor(armorData.EquipmentID);
            }
        ...
        else if (data is HelmetData helmetData)
        {
            ...
            if (attrs != null)
            {
                ...
                attrs?.SetEquippedHelmet(helmetData.EquipmentID);
            }
    ...
    public void DeEquipWeapon(EquipmentItem item)
    {
        if (item == null)
        {
            Debug.LogWarning("[PlayerCombat] EquipWeapon received null, skipping.");
        ...
        else if (data is ArmorData armorData)
        {
            ...
            {
                var sr = bodyArmorTf.GetComponent<SpriteRenderer>();
                Sprite armorSprite = Resources.Load<Sprite>("Addons/Legacy/0_Unit/0_Sprite/5_Armor/Armor_2");
                if (sr != null)
